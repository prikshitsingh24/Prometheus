...
namespace Prometheus {
	...
	void Renderer2D::Init()
	{
		...
		s_Data->FlatColorShader = Prometheus::Shader::Create("assets/Shaders/FlatColor.glsl");
	}
	void Renderer2D::End()
	{
		delete s_Data;
	...
	{
		std::dynamic_pointer_cast<OpenGLShader>(s_Data->FlatColorShader)->Bind();
		std::dynamic_pointer_cast<Prometheus::OpenGLShader>(s_Data->FlatColorShader)->UploadUniformFloat4("u_Color", color);
